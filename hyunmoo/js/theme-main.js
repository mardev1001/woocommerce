...
//Common interface section	
	...
	if(!$('.skin-secondary').hasClass('sbutton'))
	...
	$(".menu ul").addClass("nav");$(".menu ul").addClass("navbar-nav");
	$(".menu ul ul").removeClass("nav");$(".menu ul ul").removeClass("navbar-nav");
	$(".menu ul li").addClass("navli");$(".menu ul li li").removeClass("navli");
	...
	var menuwidthset=$(window).width()-$("#logo").width()-$("#searchformandcart").width()-220;
	var ji=0;
	...
	$(window).resize(function(){
		menuwidthset=$(window).width()-$("#logo").width()-$("#searchformandcart").width()-220;
	...
	$(".navmenu #rightnavarrow").click(function(){
	...
	$(".menu ul.nav li a").mouseover(function(){
		$(this).parent().find("ul.sub-menu").show();
		$(this).parent().find("ul.sub-menu").find("ul.sub-menu").hide();
	});
	$(".menu ul.nav li").mouseleave(function(){
		$(this).find("ul.sub-menu").hide();
	});
	$(".menu ul.nav li ul.sub-menu li").hover(function(){
		$(this).find("a").css("color","#fff");
		$(this).find("ul.sub-menu").find("a").css("color","#c4c7cc");
	},function(){
		$(this).find("a").css("color","#c4c7cc");
	});
//He cart section
