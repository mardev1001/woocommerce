...
if ( $attachment_ids ) {
	...
	<div class="thumbnails"><?php
		...
		foreach ( $attachment_ids as $attachment_id ) {
			...
			echo apply_filters( 'woocommerce_single_product_image_thumbnail_html', sprintf( '<a href="javascript:void(0);"  rel="{gallery: \''.$gal1.'\', smallimage: \''.$image_smalldata[0].'\',largeimage: \''.$image_link.'\',width: \''.$image_smalldata[1].'\',height: \''.$image_smalldata[2].'\'}">%s</a>', $image ), $attachment_id, $post->ID, $image_class );
