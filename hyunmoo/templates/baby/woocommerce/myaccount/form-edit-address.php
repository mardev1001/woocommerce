...
global $woocommerce, $current_user,$load_address,$address;
...
<?php else : ?>
	...
	<form id="editbillingaddress" action="<?php echo esc_url( add_query_arg( 'address', $load_address, get_permalink( woocommerce_get_page_id('edit_address') ) ) ); ?>" method="post">
