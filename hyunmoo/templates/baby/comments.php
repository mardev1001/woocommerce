...
if( post_password_required() ) { ?>
    <p class="nocomments"><?php _e( 'This post is password protected. Enter the password to view comments.', 'hyunmoo' ); ?></p>
<?php
    return; }
...
if ( have_comments() ) : ?>
    ...
    <ul class="commentlist">
     <?php
	      wp_list_comments( array( 'callback' => 'hyunmoo_comment' ) );
      ?>
    </ul>
        <div class="navigation">
            <div class="alignleft"><?php previous_comments_link() ?></div>
