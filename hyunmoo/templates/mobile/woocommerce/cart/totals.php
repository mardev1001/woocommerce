		...
		<table cellspacing="0">
			<tbody>
				...
				<tr class="cart-subtotal">
					<td class="carttotalheading"><strong><?php _e( 'Cart Subtotal', 'woocommerce' ); ?></strong></td>
				...
				<?php if ( $woocommerce->cart->get_discounts_before_tax() ) : ?>
					...
					<tr class="discount">
						<td class="carttotalheading"><?php _e( 'Cart Discount', 'woocommerce' ); ?> <a href="<?php echo add_query_arg( 'remove_discounts', '1', $woocommerce->cart->get_cart_url() ) ?>"><?php _e( '[Remove]', 'woocommerce' ); ?></a></td>
				...
				<?php if ( $woocommerce->cart->needs_shipping() && $woocommerce->cart->show_shipping() && ( $available_methods || get_option( 'woocommerce_enable_shipping_calc' ) == 'yes' ) ) : ?>
					...
					<tr class="shipping">
						<td class="carttotalheading"><?php _e( 'Shipping', 'woocommerce' ); ?></td>
				...
				<?php foreach ( $woocommerce->cart->get_fees() as $fee ) : ?>
					...
					<tr class="fee fee-<?php echo $fee->id ?>">
						<td class="carttotalheading"><?php echo $fee->name ?></td>
						<td><?php
					...
					if ( $woocommerce->cart->tax_display_cart == 'excl' ) {
						foreach ( $woocommerce->cart->get_tax_totals() as $code => $tax ) {
							echo '<tr class="tax-rate tax-rate-' . $code . '">
								<td class="carttotalheading">' . $tax->label . '</td>
				...
				<?php if ( $woocommerce->cart->get_discounts_after_tax() ) : ?>
					...
					<tr class="discount">
						<td class="carttotalheading"><?php _e( 'Order Discount', 'woocommerce' ); ?> <a href="<?php echo add_query_arg( 'remove_discounts', '2', $woocommerce->cart->get_cart_url() ) ?>"><?php _e( '[Remove]', 'woocommerce' ); ?></a></td>
				...
				<tr class="total">
					<td class="carttotalheading"><strong><?php _e( 'Order Total', 'woocommerce' ); ?></strong></td>
					<td>
