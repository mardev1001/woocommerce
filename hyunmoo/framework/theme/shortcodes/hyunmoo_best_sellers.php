<?php
	...
	function hyunmoo_shortcode_bestsellers( $atts, $content = '' )
	{	
		$default_atts = array(
			'number'	=> '10',
			'per_column'	=> '4'
		...
		$output= '<div class="hmbestseller products wrapper">';
		$output.='<input type="hidden" id="bestsellerpercolumn" value="'.$per_column.'">';
        $output.= '<h2>Best Sellers</h2>';
	...
	add_shortcode( 'hm_bestsellers', 'hyunmoo_shortcode_bestsellers' );
?>